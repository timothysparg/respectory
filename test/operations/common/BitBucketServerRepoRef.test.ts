...
describe("BitBucketServer support", () => {
    ...
    describe("should return correct clone url", () => {
        it("for project", () => {
            const bitbucketServerRepoRef = new BitBucketServerRepoRef("https://bitbucket.blahblah.co.za", "a-project", "test-app");
            assert(bitbucketServerRepoRef.cloneUrl(BitBucketServerCredentials)
                === "https://username:password@bitbucket.blahblah.co.za/scm/a-project/test-app.git");
        });
        it("for user", () => {
            const bitbucketServerRepoRef = new BitBucketServerRepoRef("https://bitbucket.blahblah.co.za", "a-user", "test-app", false);
            assert(bitbucketServerRepoRef.cloneUrl(BitBucketServerCredentials)
                === "https://username:password@bitbucket.blahblah.co.za/scm/~a-user/test-app.git");
        });
    });
    ...
    it("should create repo", () => {
        ...
        mock.onPost("https://bitbucket.blahblah.co.za/rest/api/1.0/projects/a-project/repos/")
            .reply(config => {
    ...
    it("should delete repo", () => {
        ...
        mock.onDelete("https://bitbucket.blahblah.co.za/rest/api/1.0/projects/a-project/repos/test-app")
            .reply(202, {});
    ...
    //     mock.onGet("https://bitbucket.blahblah.co.za/rest/api/1.0/projects/a-project/repos/test-app")
    //         .reply(200, { id: 1 });

    //     // tslint:disable-next-line:max-line-length
    //     mock.onGet("https://bitbucket.blahblah.co.za/rest/default-reviewers/1.0/projects/a-project/repos/test-app/reviewers?sourceRepoId=1&targetRepoId=1&sourceRefId=refs/heads/thing1&targetRefId=refs/heads/master")
    //         .reply(200, [{ name: "johndoe" }]);

    //     mock.onPost("https://bitbucket.blahblah.co.za/rest/api/1.0/projects/a-project/repos/test-app/pull-requests")
    //         .reply(config => {
    //             const postData = JSON.parse(config.data);
